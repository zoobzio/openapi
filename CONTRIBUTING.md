...
Thank you for your interest in contributing to OpenAPI! We welcome contributions from the community.

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone https://github.com/your-username/openapi.git`
...
- Maintain struct tag correctness for JSON and YAML
...
- Test both JSON and YAML serialization when adding new types
